...
# 导出gene symbol
DE_Genes <- read.csv('./03_result/02_DE/OE_ZBTB7A_vs_OE_R402C/DE.csv',row.names = 1)
...
write.xlsx(DE_Genes, file = "./03_result/02_DE/OE_ZBTB7A_vs_OE_R402C/DE_Gene_Names.xlsx")

# 3. GO KEGG --------------------------------------------------------------

## 3.1 Set path ----
DE_dir <- './03_result/02_DE/'           # 差异分析结果目录
Enrich_dir <- './03_result/03_Enrichment/'  # 富集结果存放目录
